...
public class NanoHTTPD {
  ...
  public static void main(String[] args) {
	...
	try{
		URI theURI= new URI("http://localhost:"+port+"/index.html");
  ...
  static {
    StringTokenizer st = new StringTokenizer("htm    text/html " + "html   text/html "
        ...
        + "exe    application/octet-stream " + "class    application/octet-stream "+"css    text/css "+"json    application/json ");
    while (st.hasMoreTokens())
  ...
  private static final String LICENCE = "Copyright (C) 2001,2005 by Jarno Elonen <elonen@iki.fi>\n"
   ...
   private static void take_back_up(String url,String data){
	   if(url.contains("services/backup")){
